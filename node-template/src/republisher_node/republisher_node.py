...
# from neuraverse_sdk.trigger.i_trigger import TriggerContext


class RepublisherNode(NodeBase):
    """
        ...
        return NodeVisualizationsTopics(
            topics=[
                NodeVisualizationsTopic(
                    ...
                    visualization_type="std_msgs/msg/Float64",
                )
            ]
        )
